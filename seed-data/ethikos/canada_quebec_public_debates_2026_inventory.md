...
> Package seed normalisé pour `ethikos-demo-scenario/v2`.
> Le JSON principal est la source de vérité machine et contient maintenant les sources directement sous `argument_sources`.
> Corpus: **23 acteurs · 13 débats · 58 positions · 58 arguments · 86 sources uniques · 94 liens argument→source**.
...
**Portée :** 13 débats, 23 acteurs, 58 arguments, 86 sources.  
**Passe éditoriale :** v2 — acteurs québécois, contre-expertise et relations parent/enfant.
