 ...
 *
 * It scans for **/page.tsx under modulesDir (excluding /index.test/ and any /components/ subtree)
 * and creates corresponding files under appDir that re-export the module page.
 */
