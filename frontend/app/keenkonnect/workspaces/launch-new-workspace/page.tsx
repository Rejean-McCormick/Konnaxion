      ...
      <Card>
        ...
        >
          ...
          <ProFormText
            ...
            rules={[{ required: true, message: 'Veuillez donner un nom à cet espace.' }]}
          />
          ...
          <ProFormSelect
            ...
            rules={[{ required: true, message: 'Veuillez sélectionner une équipe responsable.' }]}
          />
          ...
          <ProFormSelect
            ...
            rules={[{ required: true, message: 'Veuillez choisir au moins un outil ou environnement.' }]}
          />
...
export default function PageWrapper() {
  return (
    <KeenPageShell
      ...
      description="Configurez un nouvel espace de travail collaboratif pour votre équipe : choisissez l’équipe responsable, les outils inclus et la visibilité de l’espace."
    >
