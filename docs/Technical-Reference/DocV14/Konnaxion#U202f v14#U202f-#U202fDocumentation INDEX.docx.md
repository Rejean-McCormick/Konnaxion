> **Legacy converted-index notice (2026-09-22):** This converted `.docx.md` index predates the current documentation authority chain. Use `Konnaxion v14 - Documentation Index.md` and `../NAVIGATION_AND_SHELL_CONTRACT.md` for current navigation and ownership. Older “Kollective Intelligence module” route framing in this file is superseded.
