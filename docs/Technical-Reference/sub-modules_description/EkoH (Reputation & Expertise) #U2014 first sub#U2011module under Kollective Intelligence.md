> **Legacy navigation-model notice (2026-09-22):** This document preserves an older “Kollective Intelligence sub-module” framing. It is not the current navigation contract. EkoH is now presented as a shared capability in the suite switcher; Smart Vote is a derived-reading boundary surfaced through domain experiences and Insights; Konsensus belongs to ethiKos product navigation. See `../NAVIGATION_AND_SHELL_CONTRACT.md` and `../BOUNDARIES_AND_OWNERSHIP.md`.
