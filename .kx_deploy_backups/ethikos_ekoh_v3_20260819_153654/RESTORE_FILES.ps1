...
$Backup = "C:\\mycode\\Konnaxion\\Konnaxion\\.kx_deploy_backups\\ethikos_ekoh_v3_20260819_153654\\files"
...
New-Item -ItemType Directory -Force -Path (Split-Path (Join-Path $Repo "backend\\konnaxion\\ekoh\\models\\taxonomy.py")) | Out-Null
Copy-Item -Force (Join-Path $Backup "backend\\konnaxion\\ekoh\\models\\taxonomy.py") (Join-Path $Repo "backend\\konnaxion\\ekoh\\models\\taxonomy.py")
...
New-Item -ItemType Directory -Force -Path (Split-Path (Join-Path $Repo "backend\\konnaxion\\ethikos\\demo_import\\__pycache__\\schema.cpython-313.pyc")) | Out-Null
Copy-Item -Force (Join-Path $Backup "backend\\konnaxion\\ethikos\\demo_import\\__pycache__\\schema.cpython-313.pyc") (Join-Path $Repo "backend\\konnaxion\\ethikos\\demo_import\\__pycache__\\schema.cpython-313.pyc")
...
New-Item -ItemType Directory -Force -Path (Split-Path (Join-Path $Repo "backend\\konnaxion\\ethikos\\demo_import\\views.py")) | Out-Null
Copy-Item -Force (Join-Path $Backup "backend\\konnaxion\\ethikos\\demo_import\\views.py") (Join-Path $Repo "backend\\konnaxion\\ethikos\\demo_import\\views.py")
